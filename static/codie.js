        ...
        if (contentValue == 1) {
            if (checkImgPromt(userValue)) {
                ...
                imageGen({    
                    ...
                    aiOutput.innerHTML = "Here's your image!"
                ...
                textGen({ 
                    ...
                    console.log(response)
                    let aiContentValue = response["choices"][0]["message"]["content"]
                    frame.appendChild(userInput)
                    frame.appendChild(aiOutput)
                    userInput.innerHTML = userValue
                    aiOutput.innerHTML = aiContentValue
                    ...
                    frame.scrollTop = frame.scrollHeight
                    resetPlaceholder()
                    records.push("User: " + aiContentValue)
